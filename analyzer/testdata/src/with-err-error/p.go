...
func positive() {
	...
	var err error
	fmt.Sprintf("%s", errSentinel) // want "error-format: fmt.Sprintf can be replaced with errSentinel.Error()"
	fmt.Sprintf("%v", errSentinel) // want "error-format: fmt.Sprintf can be replaced with errSentinel.Error()"
	fmt.Sprint(errSentinel)        // want "error-format: fmt.Sprint can be replaced with errSentinel.Error()"
	fmt.Sprintf("%s", io.EOF)      // want "error-format: fmt.Sprintf can be replaced with io.EOF.Error()"
	fmt.Sprintf("%v", io.EOF)      // want "error-format: fmt.Sprintf can be replaced with io.EOF.Error()"
	fmt.Sprint(io.EOF)             // want "error-format: fmt.Sprint can be replaced with io.EOF.Error()"
	fmt.Sprintf("%s", err)         // want "error-format: fmt.Sprintf can be replaced with err.Error()"
	fmt.Sprintf("%v", err)         // want "error-format: fmt.Sprintf can be replaced with err.Error()"
	fmt.Sprint(err)                // want "error-format: fmt.Sprint can be replaced with err.Error()"
...
func suggestedFixesTest() {
	...
	fmt.Println(fmt.Sprint(errSentinel))        // want "error-format: fmt.Sprint can be replaced with errSentinel.Error()"
	fmt.Println(fmt.Sprintf("%s", errSentinel)) // want "error-format: fmt.Sprintf can be replaced with errSentinel.Error()"
